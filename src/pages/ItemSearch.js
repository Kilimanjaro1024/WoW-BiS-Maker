...
const ItemSearch = ({setBisList, bisList, accessToken}) => {
    ...
    return (
        <>
            ...
            <ItemList searchName={searchName} searchType={searchType} searchSlot={searchSlot} setBisList={setBisList} bisList={bisList} accessToken={accessToken}/>
        </>
    )
